...
jQuery(document).ready(function() {
	...
	jQuery(document).on("click", "#add_designation_btn", function(e) {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_add_designation_action",
				name: name,
				color: color,
				status: status,
				nounce: nounce
			...
			success: function(response) {
				if (response) {
					if (response.status == "error") {
						...
						jQuery("#add_designation_form .wp-color-result").css(
							"background-color",
							"none"
						);
	...
	jQuery(document).on("click", ".designation-edit-a", function(e) {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_edit_designation_action",
				key: key,
				nounce: nounce
			},
			success: function(response) {
				if (response) {
					if (response == "Something went wrong.!") {
						...
						jQuery("#edit_designation_form #edit_designation_name").val(
							response.name
						);
						jQuery("#edit_designation_form #edit_designation_color").val(
							response.color
						);
						jQuery("#edit_designation_form .wp-color-result").css(
							"background-color",
							response.color
						);
						jQuery("#edit_designation_form #edit_designation_status").val(
							response.status
						);
	...
	jQuery(document).on("click", "#edit_designation_btn", function(e) {
		...
		var status = jQuery(
			"#edit_designation_form #edit_designation_status"
		).val();
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_update_designation_action",
				name: name,
				key: key,
				color: color,
				status: status,
	...
	jQuery(document).on("click", ".designation-delete-a", function(e) {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_delete_designation_action",
				key: key,
				nounce: nounce
			},
			success: function(response) {
	...
	jQuery(document).on("click", ".shift-delete-a", function() {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_delete_shift_action",
				shift_key: shift_key,
				nounce: nounce
			},
			success: function(response) {
	...
	jQuery(document).on("click", "#edit_shift_btn", function() {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_update_shift_action",
				name: name,
				start: start,
				end: end,
				late: late,
	...
	jQuery(document).on("click", "#edit_event_btn", function(e) {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_update_event_action",
				desc: desc,
				name: name,
				key: key,
				date: date,
	...
	jQuery(document).on("click", ".event-delete-a", function(e) {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_delete_event_action",
				key: key,
				nounce: nounce
			},
			success: function(response) {
			...
			success: function(response) {
				if (response) {
					if (response == "Something went wrong.!") {
						...
						jQuery("#edit_notice_form #edit_notice_status").val(
							response.status
						);
	...
	jQuery(document).on("click", "#edit_notice_btn", function(e) {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_update_notice_action",
				desc: desc,
				name: name,
				key: key,
				status: status,
	...
	jQuery(document).on("click", ".notice-delete-a", function(e) {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_delete_notice_action",
				key: key,
				nounce: nounce
			},
			success: function(response) {
	...
	jQuery(document).on("click", ".holiday-edit-a", function(e) {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_edit_holiday_action",
				key: key,
				nounce: nounce
			},
			success: function(response) {
				if (response) {
					if (response == "Something went wrong.!") {
						...
						jQuery("#edit_holiday_form #edit_holiday_start").val(
							response.start
						);
						jQuery("#edit_holiday_form #edit_holiday_to").val(response.to);
						jQuery("#edit_holiday_form #edit_holiday_status").val(
							response.status
						);
	...
	jQuery(document).on("click", "#edit_holiday_btn", function(e) {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_update_holiday_action",
				name: name,
				start: start,
				to: to,
				key: key,
	...
	jQuery(document).on("click", ".holiday-delete-a", function(e) {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_delete_holiday_action",
				key: key,
				nounce: nounce
			},
			success: function(response) {
			...
			success: function(response) {
				if (response) {
					if (response == "Something went wrong.!") {
						...
						jQuery("#edit_staff_form #edit_staff_location").val(
							response.locations
						);
						...
						for (var i = 0; i < names.length; i++) {
							...
							document
								.getElementById("edit_dynamic_leave_fields")
								.appendChild(l);
	...
	jQuery(document).on("click", "#edit_staff_btn", function() {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_update_staff_action",
				name: name,
				first: first,
				last: last,
				email: email,
	...
	jQuery(document).on("click", ".staff-delete-a", function() {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: {
				action: "hrm_delete_staff_action",
				staff_key: staff_key,
				nounce: nounce
			},
			success: function(response) {
			...
			success: function(response) {
				if (response) {
					if (response == "Something went wrong.!") {
						...
						jQuery("#edit_request_form #edit_holiday_start").val(
							response.start
						);
						...
						jQuery("#edit_request_form #edit_request_status").val(
							response.status
						);
					}
				}
