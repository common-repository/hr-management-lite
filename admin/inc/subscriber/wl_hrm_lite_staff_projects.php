                            ...
                            <table id="project_table" class="table table-striped report_table" cellspacing="0" style="width:100%">
                                ...
                                <?php 
                                    ...
                                    foreach ( $all_projects as $key => $project ) {
										...
										$check_empty = count($members);
										if( is_array($members) && $check_empty > 0 && in_array( $the_current_user, $members) ) {
											?>
											<tr>
		     	...
		     	<div class="card">
	                <div class="card-body">
	                  ...
	                  <form class="forms-sample" method="post" id="add_project_form">
						...
						<div class="form-group">
	                      	<label for="project_members"><?php esc_html_e( 'Select Members', 'hr-management-lite' ); ?></label>
	                ...
	                <div class="card-body">
	                  ...
	                  <form class="forms-sample" method="post" id="edit_project_form">
						...
						<div class="form-group">
							...
							<select name="edit_project_members" id="edit_project_members" class="member-select" >
								<?php foreach ( $staffs as $key => $staff ) { ?>
                                    <option value="<?php echo esc_attr( $staff['ID'] ); ?>"><?php echo esc_html( $staff['fullname'] ); ?></option>
                                <?php } ?>
							</select>
	                ...
	                <div class="card-body">
	                  ...
	                  <form class="forms-sample" method="post" id="edit_task_form" autocomplete="off">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="edit_task_due" placeholder="<?php esc_html_e('Format:- YYYY-MM-DD', 'hr-management-lite'); ?>" data-toggle="datetimepicker" data-target="#edit_task_due">
						</div>
