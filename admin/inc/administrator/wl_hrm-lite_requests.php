		     	...
		     	<div class="card">
	                <div class="card-body">
	                  ...
	                  <form class="forms-sample" method="post" id="edit_request_form">
	                      ...
	                      <input type="text" class="form-control" id="edit_request_name" placeholder="<?php esc_html_e( 'Name', 'hr-management-lite' ); ?>" readonly>
	                    </div>
	                    <div class="form-group">
	                      <label for="edit_notice_desc"><?php esc_html_e( 'Request Description', 'hr-management-lite' ); ?></label>
	                      <textarea class="form-control" rows="4" id="edit_notice_desc" name="edit_notice_desc" placeholder="<?php esc_html_e( 'Description....', 'hr-management-lite' ); ?>" readonly></textarea>
                        </div>
                        <div class="form-group">
	                      <label for="edit_holiday_start"><?php esc_html_e( 'Holiday From', 'hr-management-lite' ); ?></label>
	                      <input type="text" class="form-control" name="edit_holiday_start" id="edit_holiday_start" placeholder="<?php esc_html_e( 'Format:- YYYY-MM-DD', 'hr-management-lite' ); ?>" readonly>
	                    </div>
	                    <div class="form-group">
	                      <label for="edit_holiday_to"><?php esc_html_e( 'Holiday To', 'hr-management-lite' ); ?></label>
	                      <input type="text" class="form-control" id="edit_holiday_to" placeholder="<?php esc_html_e( 'Format:- YYYY-MM-DD', 'hr-management-lite' ); ?>" readonly>
						</div>
						<div class="form-group">
	                      	<label for="edit_request_status"><?php esc_html_e( 'Status', 'hr-management-lite' ); ?></label>
	                      	<select name="edit_request_status" id="edit_request_status" class="form-control">
	                      		<option value="<?php echo esc_attr('Pending'); ?>"><?php esc_html_e( 'Pending', 'hr-management-lite' ); ?></option>
	                      		<option value="<?php echo esc_attr('Approved'); ?>"><?php esc_html_e( 'Approved', 'hr-management-lite' ); ?></option>
	                      		<option value="<?php echo esc_attr('Canceled'); ?>"><?php esc_html_e( 'Canceled', 'hr-management-lite' ); ?></option>
	                      	</select>
	                    </div>
